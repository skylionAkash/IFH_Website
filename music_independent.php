        ...
        <div class="row">
          <div class="col-md-12">
            <div class="btn-group btn-breadcrumb breadcrumb-default">
              ...
              <a href="JavaScript:Void(0);" class="btn btn-default "> &nbsp; Music </a>
              <a href="JavaScript:Void(0);" style="text-transform: capitalize;" id="slugname" class="btn btn-default ">&nbsp;Independent Artist </a>
            </div>
          </div>
        </div>
        ...
        <div class="row filter-form">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <form id="search_frm" method="post">
              <div class="row filter-form">
                <div class="col-md-3 col-6 movies-no-pad-right mob-row-no-pad-left">
                ...
                <div class="col-md-3 col-6 movies-no-pad-right mob-row-no-pad-left2">
                ...
                <div class="col-md-3 col-12 float-end mob-row-no-pad">
          ...
          <div class="col-md-12">
            <div class="upcoming-box">
              <div class="row no-margin">
                <!-- item-1 -->
                <div class="box-card col-md-3 col-4 pinside2">
                  <a href="music_independent_details">
                    <img src="images/upcoming-movies/mehak-malhotra.jpg" alt="">
                    <h5>Mehak Malhotra</h5>
                    <div class="rating">
                      <span class="celeb-type c-m-independent"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="far fa-star"></i> <span class="bold">4</span></span>
                    </div>
                  </a>
                </div>
                <!-- item-2 -->
                <div class="box-card col-md-3 col-4 pinside2">
                  <a href="music_independent_details">
                    ...
                    <h5>Mehak Malhotra</h5>
                    <div class="rating">
                      <span><i class="fas fa-star"></i> Not rated yet</span>
                    </div>
                  </a>
                </div>
                <!-- item-3 -->

        ...
        <div class="row">
          <div class="col-md-12">
            <div class="btn-group btn-breadcrumb breadcrumb-default">
              ...
              <a href="JavaScript:Void(0);" style="text-transform: capitalize;" id="slugname" class="btn btn-default ">&nbsp;Magazine </a>
            </div>
          </div>
        </div>
        ...
        <div class="row listing-page-content">
          <div class="upcoming-box video-row news-grid">
            <div class="gallery-photo-section">
              <div class="row">
                <div class="col-md-3 col-sm-3 col-4 mob-pad-3px">
                  <a href="magazine-details">
                    <div class="demo">
                      <img src="images/upcoming-movies/Magazine.jpeg" alt="" class="demo-image">
                      <h2>Women Fitness India Magazine DEC 2020</h2>
                    </div>
                  </a>
                </div>
                <!-- new item -->

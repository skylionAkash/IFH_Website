    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-12">
            <div class="btn-group btn-breadcrumb breadcrumb-default">
              ...
              <a href="JavaScript:Void(0);" class="btn btn-default "> &nbsp; Association </a>
              <!-- <a href="JavaScript:Void(0);" style="text-transform: capitalize;" id="slugname" class="btn btn-default ">&nbsp;Upcoming Movies</a> -->
            </div>
          </div>
        </div>
            ...
            <form id="search_frm" method="post">
              <div class="row filter-form">
                ...
                <div class="col-md-3 col-4 movies-no-pad-right mob-row-no-pad-left2">
                  <label class="control-label" for="capacity">Sort</label>
        ...
        <div class="row listing-page-content">
          <div class="col-md-12">
            <div class="upcoming-news-box upcoming-box">
              <div class="row upcoming-news-box-row-pad">
                <!-- new item -->
                <div class="col-md-3 col-4 upcoming-news-col-pad">
                  <a href="indian-motion-picture-producers-association" class="upcoming-news-item">
                    <div class="upcoming-news-bg association-bg">
                      <img src="images/upcoming-movies/imppa.jpeg" alt="">
                      <h2>Indian Motion Picture Producers Association</h2>
                    </div>
                  </a>
                </div>
                <!-- new item -->
